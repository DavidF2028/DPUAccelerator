...
proc create_root_design { parentCell } {
  ...
  # Create instance: out_bram_ctrl, and set properties
  set out_bram_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 out_bram_ctrl ]
  set_property CONFIG.SINGLE_PORT_BRAM {1} $out_bram_ctrl
  ...
  set_property CONFIG.SINGLE_PORT_BRAM {1} $input_bram_ctrl
  ...
  set_property CONFIG.SINGLE_PORT_BRAM {1} $weight_bram_ctrl
  ...
  # Create instance: out_blk_mem, and set properties
  set out_blk_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 out_blk_mem ]
  set_property -dict [list \
    CONFIG.Byte_Size {8} \
...
\
  ...
  # Create instance: dpu_axi_0, and set properties
  set dpu_axi_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:dpu_axi:1.6 dpu_axi_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins dpu_axi_0/s00_axi]
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins smartconnect_0/M01_AXI] [get_bd_intf_pins input_bram_ctrl/S_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins weight_bram_ctrl/S_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins smartconnect_0/M03_AXI] [get_bd_intf_pins out_bram_ctrl/S_AXI]
  ...
  [get_bd_pins input_bram_ctrl/s_axi_aresetn] \
  [get_bd_pins weight_bram_ctrl/s_axi_aresetn] \
  [get_bd_pins out_bram_ctrl/s_axi_aresetn] \
  [get_bd_pins smartconnect_0/aresetn] \
  [get_bd_pins dpu_axi_0/s00_axi_aresetn]
  connect_bd_net -net blk_mem_gen_0_doutb  [get_bd_pins input_blk_mem/doutb] \
  [get_bd_pins dpu_axi_0/in_bram_dout]
  connect_bd_net -net dpu_axi_0_in_bram_addr  [get_bd_pins dpu_axi_0/in_bram_addr] \
  [get_bd_pins input_blk_mem/addrb]
  connect_bd_net -net dpu_axi_0_in_bram_en  [get_bd_pins dpu_axi_0/in_bram_en] \
  [get_bd_pins input_blk_mem/enb]
  connect_bd_net -net dpu_axi_0_out_bram_addr  [get_bd_pins dpu_axi_0/out_bram_addr] \
  [get_bd_pins out_blk_mem/addrb]
  connect_bd_net -net dpu_axi_0_out_bram_din  [get_bd_pins dpu_axi_0/out_bram_din] \
  [get_bd_pins out_blk_mem/dinb]
  connect_bd_net -net dpu_axi_0_out_bram_en  [get_bd_pins dpu_axi_0/out_bram_en] \
  [get_bd_pins out_blk_mem/enb]
  connect_bd_net -net dpu_axi_0_out_bram_we  [get_bd_pins dpu_axi_0/out_bram_we] \
  [get_bd_pins out_blk_mem/web]
  connect_bd_net -net dpu_axi_0_w_bram_addr  [get_bd_pins dpu_axi_0/w_bram_addr] \
  [get_bd_pins weight_blk_mem/addrb]
  connect_bd_net -net dpu_axi_0_w_bram_en  [get_bd_pins dpu_axi_0/w_bram_en] \
  [get_bd_pins weight_blk_mem/enb]
  connect_bd_net -net input_blk_mem_douta  [get_bd_pins input_blk_mem/douta] \
  [get_bd_pins input_bram_ctrl/bram_rddata_a]
  connect_bd_net -net input_bram_ctrl_bram_addr_a  [get_bd_pins input_bram_ctrl/bram_addr_a] \
  [get_bd_pins input_blk_mem/addra]
  connect_bd_net -net input_bram_ctrl_bram_clk_a  [get_bd_pins input_bram_ctrl/bram_clk_a] \
  [get_bd_pins input_blk_mem/clka]
  connect_bd_net -net input_bram_ctrl_bram_en_a  [get_bd_pins input_bram_ctrl/bram_en_a] \
  [get_bd_pins input_blk_mem/ena]
  connect_bd_net -net input_bram_ctrl_bram_rst_a  [get_bd_pins input_bram_ctrl/bram_rst_a] \
  [get_bd_pins input_blk_mem/rsta]
  connect_bd_net -net input_bram_ctrl_bram_we_a  [get_bd_pins input_bram_ctrl/bram_we_a] \
  [get_bd_pins input_blk_mem/wea]
  connect_bd_net -net input_bram_ctrl_bram_wrdata_a  [get_bd_pins input_bram_ctrl/bram_wrdata_a] \
  [get_bd_pins input_blk_mem/dina]
  connect_bd_net -net out_blk_mem_douta  [get_bd_pins out_blk_mem/douta] \
  [get_bd_pins out_bram_ctrl/bram_rddata_a]
  connect_bd_net -net out_bram_ctrl_bram_addr_a  [get_bd_pins out_bram_ctrl/bram_addr_a] \
  [get_bd_pins out_blk_mem/addra]
  connect_bd_net -net out_bram_ctrl_bram_clk_a  [get_bd_pins out_bram_ctrl/bram_clk_a] \
  [get_bd_pins out_blk_mem/clka]
  connect_bd_net -net out_bram_ctrl_bram_en_a  [get_bd_pins out_bram_ctrl/bram_en_a] \
  [get_bd_pins out_blk_mem/ena]
  connect_bd_net -net out_bram_ctrl_bram_rst_a  [get_bd_pins out_bram_ctrl/bram_rst_a] \
  [get_bd_pins out_blk_mem/rsta]
  connect_bd_net -net out_bram_ctrl_bram_we_a  [get_bd_pins out_bram_ctrl/bram_we_a] \
  [get_bd_pins out_blk_mem/wea]
  connect_bd_net -net out_bram_ctrl_bram_wrdata_a  [get_bd_pins out_bram_ctrl/bram_wrdata_a] \
  [get_bd_pins out_blk_mem/dina]
  connect_bd_net -net weight_blk_mem_douta  [get_bd_pins weight_blk_mem/douta] \
  [get_bd_pins weight_bram_ctrl/bram_rddata_a]
  connect_bd_net -net weight_blk_mem_doutb  [get_bd_pins weight_blk_mem/doutb] \
  [get_bd_pins dpu_axi_0/w_bram_dout]
  connect_bd_net -net weight_bram_ctrl_bram_addr_a  [get_bd_pins weight_bram_ctrl/bram_addr_a] \
  [get_bd_pins weight_blk_mem/addra]
  connect_bd_net -net weight_bram_ctrl_bram_clk_a  [get_bd_pins weight_bram_ctrl/bram_clk_a] \
  [get_bd_pins weight_blk_mem/clka]
  connect_bd_net -net weight_bram_ctrl_bram_en_a  [get_bd_pins weight_bram_ctrl/bram_en_a] \
  [get_bd_pins weight_blk_mem/ena]
  connect_bd_net -net weight_bram_ctrl_bram_rst_a  [get_bd_pins weight_bram_ctrl/bram_rst_a] \
  [get_bd_pins weight_blk_mem/rsta]
  connect_bd_net -net weight_bram_ctrl_bram_we_a  [get_bd_pins weight_bram_ctrl/bram_we_a] \
  [get_bd_pins weight_blk_mem/wea]
  connect_bd_net -net weight_bram_ctrl_bram_wrdata_a  [get_bd_pins weight_bram_ctrl/bram_wrdata_a] \
  [get_bd_pins weight_blk_mem/dina]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0  [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] \
  [get_bd_pins input_bram_ctrl/s_axi_aclk] \
  [get_bd_pins weight_bram_ctrl/s_axi_aclk] \
  [get_bd_pins out_blk_mem/clkb] \
  [get_bd_pins out_bram_ctrl/s_axi_aclk] \
  [get_bd_pins input_blk_mem/clkb] \
  [get_bd_pins weight_blk_mem/clkb] \
  [get_bd_pins proc_sys_reset_0/slowest_sync_clk] \
  [get_bd_pins smartconnect_0/aclk] \
  [get_bd_pins smartconnect_0/aclk1] \
  [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] \
  [get_bd_pins dpu_axi_0/s00_axi_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0  [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] \
  [get_bd_pins proc_sys_reset_0/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0x80000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs dpu_axi_0/s00_axi/reg0] -force
  assign_bd_address -offset 0x82000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs input_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x84000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs out_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x86000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs weight_bram_ctrl/S_AXI/Mem0] -force
