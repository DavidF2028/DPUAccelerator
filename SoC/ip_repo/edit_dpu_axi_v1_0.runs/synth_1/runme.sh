...
HD_PWD='C:/Users/Admin/ip_repo/edit_dpu_axi_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dpu_axi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dpu_axi.tcl
